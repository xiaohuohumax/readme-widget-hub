...
| -------------------- | -------------------- | ------------------------ | ----------------------- | --------------------------- | ------------------------------- |
| ![ref-params] | | | | | |
| `countId` | `string` | `true` |  | Unique counter name | Not allowed to contain special characters. |
| ![ref-querys] | | | | | |
...
![Moe Counter](https://count.getloli.com/@xiaohuohumax-readme-widget-hub)
```

<div>
  <img src="https://count.getloli.com/@xiaohuohumax-readme-widget-hub" alt="Moe Counter" />
</div>
