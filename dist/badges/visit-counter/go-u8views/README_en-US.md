...
| `type` | `string` | `true` |  | Statistics type | Supported: `day-week-month-total-count` (all) `day-count` (day) `week-count` (week) `month` (monthly) `total-count` (total). |
...
<div>
  <img src="https://u8views.com/api/v1/github/profiles/121827373/views/day-week-month-total-count.svg" alt="View statistics" />
</div>
