...
[![ref-official-doc]](https://github.com/KevzPeter/Leetcode-Badge-Showcase?tab=readme-ov-file#-add-to-your-readme-page)
...
| `animated` | `boolean` |  |  | Animated Badges | Supported: `true` `false`. |
| `theme` | `string` |  | `dark` | Theme | Supported: `dark` `light` `github-dark` `monokai` `tokyonight` `nightowl` More themes please refer to [Themes](https://github.com/KevzPeter/Leetcode-Badge-Showcase?tab=readme-ov-file#-themes). |
| `filter` | `string` |  |  | show a specific set of badges | Supported: `comp` `study` `annual` `submission` `daily`. |
| `border` | `string` |  |  | Show border | Supported: `border` `no-border`. |
...
```markdown
<!-- kevzpeter -->
![Leetcode Badges](https://leetcode-badge-showcase.vercel.app/api?username=kevzpeter&filter=annual&border=no-border&theme=github-dark)
```

<div>
  <img src="https://leetcode-badge-showcase.vercel.app/api?username=kevzpeter&#38;filter=annual&#38;border=no-border&#38;theme=github-dark" alt="Leetcode Badges" />
</div>
