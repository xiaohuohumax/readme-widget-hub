...
| -------------------- | -------------------- | ------------------------ | ----------------------- | --------------------------- | ------------------------------- |
| ![ref-querys] | | | | | |
| `profileName` | `string` | `true` |  | Steam username | Please ensure that your Steam profile is public! |
...
```markdown
<!-- topson -->
![Steam Stats Card](https://steam-stat.vercel.app/api?profileName=topson)
```

<div>
  <img src="https://steam-stat.vercel.app/api?profileName=topson" alt="Steam Stats Card" />
</div>
