...
| -------------------- | -------------------- | ------------------------ | ----------------------- | --------------------------- | ------------------------------- |
| ![ref-querys] | | | | | |
| `username` | `string` | `true` |  | Username registered in Credly website. | Example: `ashishsinghbaghel` |
| `theme` | `string` |  | `default` | Theme color. | Supported: `default`, `dark` or `tokyonight`. |

</details>

```txt
https://github-readme-widgets.vercel.app/api{?username,theme}
```
...
```markdown
<!-- Certifications -->
![Credly Certifications Widget](https://github-readme-widgets.vercel.app/api?username=ashishsinghbaghel&theme=dark)
```

<div>
  <img src="https://github-readme-widgets.vercel.app/api?username=ashishsinghbaghel&#38;theme=dark" alt="Credly Certifications Widget" />
</div>
