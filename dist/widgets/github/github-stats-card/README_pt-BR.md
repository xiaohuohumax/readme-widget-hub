...
**Criação de um maravilhoso cartão com as estatísticas do GitHub no seu Readme.**

[![ref-repo]](https://github.com/jxmked/github-stats-card)
[![ref-official-doc]](https://github.com/jxmked/github-stats-card?tab=readme-ov-file#generate-yours-now)
...
```txt
https://gh-stats-card.vercel.app/api/{username}
```
...
```markdown
<!-- jxmked -->
![Estatísticas do jxmked no GitHub](https://gh-stats-card.vercel.app/api/jxmked)
```

<div>
  <img src="https://gh-stats-card.vercel.app/api/jxmked" alt="Estatísticas do jxmked no GitHub" />
</div>
