...
## Emblema do Discord no README (Discord README Badge)

**Mostre o que você está fazendo no seu arquivo de readme do GitHub!**
...
| -------------------- | -------------------- | ------------------------ | ----------------------- | --------------------------- | ------------------------------- |
| ![ref-querys] | | | | | |
| `id` | `string` |  |  | ID do Usuário do Discord |  |
...
```markdown
<!-- Zyplos -->
![Status do Discord](https://discord-readme-badge.vercel.app/api?id=204620732259368960)
```

<div>
  <img src="https://discord-readme-badge.vercel.app/api?id=204620732259368960" alt="Status do Discord" />
</div>
